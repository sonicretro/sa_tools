...
namespace ModGenerator
{
	public partial class MainForm : Form
	{
		public MainForm()
		{
            ...
            DialogResult lookForNewPath = DialogResult.None;
		...
		private void NewProjectButton_Click(object sender, EventArgs e)
		{
            ...
            Enabled = false; // This used to be a hide/show system but for some reason it was stuffing the window into the background.
            DialogResult projectResult = newProjectForm.ShowDialog();
            if (projectResult == DialogResult.Cancel)
            {
                Enabled = true;
            }

...
{
	/// <summary>
	/// Previously called 'IniData', it has been re-named to give a better idea of what it does, as well as to dis-ambiguate it from other ini
	/// files used by the toolkit. sonic_data.ini is a notable example of this - and what it does is provide a list of data structures inside of an executable file
	/// that have been split off into separate files for easier editing.
	/// </summary>
